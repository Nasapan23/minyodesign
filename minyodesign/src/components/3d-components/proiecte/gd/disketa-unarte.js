...
export default function DisketaUnarte({ position = [0, 0, 0], scale = [1, 1, 1], rotation = [0, 0, 0], ...props }) {
  const { nodes, materials } = useGLTF('/3DObjects/gd/disketa-unarte.glb')
...
useGLTF.preload('/3DObjects/gd/disketa-unarte.glb')
