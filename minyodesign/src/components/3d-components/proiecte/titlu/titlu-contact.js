...
export default function TitluContact({ position = [0, 0, 0], scale = [1, 1, 1], rotation = [0, 0, 0], ...props }) {
  const { nodes, materials } = useGLTF('/3DObjects/titlu/titlu-contact.glb');
...
useGLTF.preload('/3DObjects/titlu/titlu-contact.glb');
